public class NumberToWords1 {
    /**
     * create a Java program that converts the given number into words.
     * For example, if the given number is 54,297 then the output should be
     * Fifty-Four Thousand Two Hundred Ninety-Seven.
     *
     * Verilen sayıyı kelimelere çeviren bir Java programı oluşturun.
     * Örneğin, verilen sayı 54.297 ise, çıktı Elli Dört Bin İki Yüz Doksan Yedi olmalıdır.
     */
